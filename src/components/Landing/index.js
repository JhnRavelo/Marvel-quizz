    ...
    const showBtn = btn && (
        <>
            <div className='leftBox'>
                <Link to="/signup">
                    <button onMouseOver={addLeftClaw} onMouseOut={clearClawImage} className='btn-welcome'>Inscription</button>
                </Link>
            </div>
            <div className='rightBox'>
                <Link to="/login">
                    <button onMouseOver={addRightClaw} onMouseOut={clearClawImage} className='btn-welcome'>Connexion</button>
                </Link>
            </div>
        </>
    )
